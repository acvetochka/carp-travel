...
export const About = () => {
  ...
  return (
    <Section id="about" className="about-bg">
      <div className="container contents grid gap-2 md:grid-cols-[218px_266px_220px] md:grid-rows-[240px_180px_117px] md:gap-x-0 md:gap-y-4 xl:grid-cols-[50%_25%_25%] xl:grid-rows-[256px_192px_120px]">
        <Title
          title={title}
          accent={titleAccent}
        ...
        {description.map(({ textAccent, text }, idx) => (
          <p
            ...
            className={`text-base-m md:text-base-t xl:text-base-d font-extralight ${
              idx === 2
                ? 'smOnly:row-start-5  md:row-start-3 md:col-start-2 md:col-span-2 md:self-end xl:col-start-1 xl:col-end-2'

...
const MobileMenu = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 w-full h-full z-[999] bg-[rgba(1, 10, 5, 0.75)] backdrop-blur-xl transform -translate-y-full opacity-0 invisible pointer-events-none ${
        isOpen && 'translate-y-0 opacity-1 visible overflow-y-scroll'

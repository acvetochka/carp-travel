...
const SlideList = ({ title, handleClick }) => {
  return (
    <ul className="list-none p-0 flex flex-col gap-4 md:row-start-2 md:col-start-2">
  ...
  return (
    <>
      ...
      >
        ...
        >
          {services.map(({ id, bg, img, losung, title, description }, idx) => (
            <div key={id} className="bg-black min-h-[542px]">
              <SwiperSlide
                className="bg-cover bg-center bg-opacity-75 min-h-[795px]"
                style={{
